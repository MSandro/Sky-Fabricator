...
public class Crucible extends Item {
                ...
                if (this.fluid == Fluids.EMPTY) {
                    ...
                    if (blockState.getBlock() instanceof FluidDrainable) {
                        ...
                        if (fluid_item != ItemStack.EMPTY) {
                            ...
                            ItemStack item = null;
                            if (fluid_item.getItem() == Items.LAVA_BUCKET || fluid_item.getItem() == ModRegistry.LAVA_CRUCIBLE) {
                                item = new ItemStack(ModRegistry.LAVA_CRUCIBLE);
                            } else if (fluid_item.getItem() == Items.WATER_BUCKET || fluid_item.getItem() == ModRegistry.WATER_CRUCIBLE) {
                                item = new ItemStack(ModRegistry.WATER_CRUCIBLE);
                            }
                            if(item!=null){
    ...
    protected ItemStack getEmptiedStack(ItemStack stack, PlayerEntity player) {
        ...
        return !player.getAbilities().creativeMode ? new ItemStack(ModRegistry.CRUCIBLE) : stack;
    }
